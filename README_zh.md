...
> 📝 **个人学习笔记**：这个项目最吸引我的是「无离散分词器」的设计思路，相比 VALL-E 等方案绕过了 codec 量化带来的信息损失，值得深入研究 AudioVAE V2 的实现细节。
>
> 🔖 **待研究**：重点看 `diffusion_autoregressive` 模块中扩散步数与推理速度的权衡，以及流式合成时如何处理上下文窗口边界的音质问题。
